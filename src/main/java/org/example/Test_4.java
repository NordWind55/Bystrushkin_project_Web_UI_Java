...
public class Test_4 {
    public static void main (String[] args){
        ...
        WebElement webElementButtonTrueLocation = driver.findElement(By.xpath("//div/button[@class='Sr Tr']"));
        webElementButtonTrueLocation.click();

        //Нажать на кнопку "Каталог" в хедере сайта.
        WebElement webElementButtonStoreCatalog = driver.findElement(By.xpath("//ul/li[@class='Ki']"));
        ...
        WebElement webElementTV = driver.findElement(By.xpath("//ul/li[@data-product-index='1']/div/a[@class='tG']"));
        webElementTV.click();
