...
public class Test_2 {
    public static void main (String[] args){
        ...
        WebElement webElementButtonLocation = driver.findElement(By.xpath("//button[@class='Si']"));
        ...
        WebElement webElementFoundCity = driver.findElement(By.xpath("//div/span/span[@class='Jz']"));
